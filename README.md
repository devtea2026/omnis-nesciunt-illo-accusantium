# @devtea2026/omnis-nesciunt-illo-accusantium

[![Build Status](https://dev.azure.com/vscode/@devtea2026/omnis-nesciunt-illo-accusantium/_apis/build/status/Microsoft.@devtea2026/omnis-nesciunt-illo-accusantium?branchName=main)](https://dev.azure.com/vscode/@devtea2026/omnis-nesciunt-illo-accusantium/_build/latest?definitionId=11&branchName=main)
...
`@devtea2026/omnis-nesciunt-illo-accusantium` supports Linux, macOS and Windows. Windows support is possible by utilizing the [Windows conpty API](https://blogs.msdn.microsoft.com/commandline/2018/08/02/windows-command-line-introducing-the-windows-pseudo-console-conpty/) on Windows 1809+ and the [winpty](https://github.com/rprichard/winpty) library in older version.

## API

The full API for @devtea2026/omnis-nesciunt-illo-accusantium is contained within the [TypeScript declaration file](https://github.com/devtea2026/omnis-nesciunt-illo-accusantium/blob/main/typings/@devtea2026/omnis-nesciunt-illo-accusantium.d.ts), use the branch/tag picker in GitHub (`w`) to navigate to the correct version of the API.

## Example Usage

```js
import * as os from 'node:os';
import * as pty from '@devtea2026/omnis-nesciunt-illo-accusantium';
...
`@devtea2026/omnis-nesciunt-illo-accusantium` powers many different terminal emulators, including:
...
Do you use @devtea2026/omnis-nesciunt-illo-accusantium in your application as well? Please open a [Pull Request](https://github.com/Tyriar/@devtea2026/omnis-nesciunt-illo-accusantium/pulls) to include it here. We would love to have it in our list.
...
Node.JS 16 or Electron 19 is required to use `@devtea2026/omnis-nesciunt-illo-accusantium`. What version of node is supported is currently mostly bound to [whatever version Visual Studio Code is using](https://github.com/devtea2026/omnis-nesciunt-illo-accusantium/issues/557#issuecomment-1332193541).
...
[The wiki](https://github.com/Microsoft/@devtea2026/omnis-nesciunt-illo-accusantium/wiki/Debugging) contains instructions for debugging @devtea2026/omnis-nesciunt-illo-accusantium.

## Security

All processes launched from @devtea2026/omnis-nesciunt-illo-accusantium will launch at the same permission level of the parent process. Take care particularly when using @devtea2026/omnis-nesciunt-illo-accusantium inside a server that's accessible on the internet. We recommend launching the pty inside a container to protect your host machine.

## Thread Safety

Note that @devtea2026/omnis-nesciunt-illo-accusantium is not thread safe so running it across multiple worker threads in node.js could cause issues.
...
This error can occur due to anti-virus software intercepting winpty from creating a pty. To workaround this you can exclude this file from your anti-virus scanning `@devtea2026/omnis-nesciunt-illo-accusantium\build\Release\winpty-agent.exe`
